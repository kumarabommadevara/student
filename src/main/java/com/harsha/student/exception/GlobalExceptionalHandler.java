...
public class GlobalExceptionalHandler {
    ...
    public ErrorResponse handleHttpClientErrorException(WebRequest request, Exception e) {

        return new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.toString(), new Date(), e.getMessage(), request.getDescription(false));
    }
}